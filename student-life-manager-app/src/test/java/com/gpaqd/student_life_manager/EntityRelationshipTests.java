...
@SpringBootTest
@ActiveProfiles("test")
@Transactional // Ensures each test method runs within a transaction
class EntityRelationshipTests {
    ...
    void testUserCourseRelationships() {
        ...
        // 4. Create a Lab and associate with the Course
        ...
        // 5. Create a MyTest and associate with the Course
        ...
        // 6. Create a Project and associate with the Course
        ...
        // 7. Save the User again (to persist updated relationships in the same transaction)
        userRepository.save(user);
        ...
        System.out.println("[PASS] Course test passed.");
        System.out.flush();
        ...
        System.out.println("[PASS] Lab test passed.");
        System.out.flush();
        ...
        System.out.println("[PASS] Test test passed.");
        System.out.flush();
        ...
        System.out.println("[PASS] Project test passed.");
        System.out.flush();
    }
}
